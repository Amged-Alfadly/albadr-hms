...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
    ...
    if ($new_password !== $confirm_password) {
        ...
        if ($user && password_verify($current_password, $user['password'])) {
            ...
            $message = "تم تغيير كلمة السر بنجاح. يرجى استخدامها في المرة القادمة.";
        } else {
...
?>
            ...
            <li><a href="patients_report.php">تقرير المرضى الشامل</a></li>
    ...
    <div class="content" style="background: #f8f9fa; display: flex; align-items: center; justify-content: center; height: 100vh; overflow: hidden;">
        ...
        <div class="premium-password-container">
            ...
            <div class="password-card-footer">
                <a href="index.php">العودة للوحة الإدارة</a>
            </div>
        </div>
        ...
        <style>
            ...
            .input-wrapper input {
                width: 100% !important;
                padding: 12px 15px 12px 45px !important; /* Extra padding on left for icon */
            ...
            .input-wrapper input:focus {
                ...
                box-shadow: 0 0 0 5px rgba(255, 140, 0, 0.1) !important;
            }
            ...
            .btn-premium-action:hover .btn-glow {
                left: 100%;
            }
